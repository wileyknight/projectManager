        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Avatar = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Company = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Attempts = table.Column<int>(nullable: true),
                    securityID = table.Column<string>(unicode: false, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileName = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    FileSize = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    ContentType = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    FileLocation = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    FileType = table.Column<string>(unicode: false, maxLength: 20, nullable: true),
                    Status = table.Column<string>(unicode: false, maxLength: 20, nullable: true),
                    Comment = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Refrence = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Pos = table.Column<int>(nullable: true),
                    Neg = table.Column<int>(nullable: true),
                    Viewed = table.Column<string>(unicode: false, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Zip = table.Column<int>(nullable: true),
                    Logo = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Background = table.Column<string>(unicode: false, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Attachment = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Pin = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Comment = table.Column<string>(type: "text", nullable: true),
                    Type = table.Column<string>(unicode: false, maxLength: 20, nullable: true),
                    Recipients = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Pos = table.Column<int>(nullable: true),
                    Neg = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rate = table.Column<string>(unicode: false, maxLength: 10, nullable: true),
                    Due = table.Column<string>(unicode: false, maxLength: 10, nullable: true),
                    Category = table.Column<string>(unicode: false, maxLength: 20, nullable: true),
                    Company = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Status = table.Column<string>(unicode: false, maxLength: 20, nullable: true),
                    Accounts = table.Column<string>(unicode: false, maxLength: 255, nullable: true),
                    Date = table.Column<DateTime>(type: "date", nullable: true),
                    Time = table.Column<TimeSpan>(nullable: true)
                },
                constraints: table =>
